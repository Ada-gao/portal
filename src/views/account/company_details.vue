...
import consump_recode from 'components/company_details/consump_recode'
import product_manage_recode from 'components/company_details/product_manage_recode'
import company_details from 'components/company_details/company_details'
import account_details from 'components/company_details/account_details'
export default {
    ...
    methods: {
    	...
    	check_type(type){
    		this.type = type;
            this.$router.replace({path:'/account/handle/company_details', query: {type: this.type,userId:this.userId,deptId:this.deptId,username:this.username}});
    	}
    }
}
</script>
