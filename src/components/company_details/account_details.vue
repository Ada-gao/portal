    ...
    <div>
        ...
        <el-form class="company_details pt20" label-width="100px" v-loading="loading" element-loading-text="给我一点时间">
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <el-form-item label="账户创建时间：" class="omit1"><span>{{basic_info.updateTime | moment('YYYY-MM-DD HH:mm:ss')}}</span></el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="账户到期时间：" class="omit1"><span>{{basic_info.expirationDate | moment('YYYY-MM-DD HH:mm:ss')}}</span></el-form-item>
                </el-col>
            </el-row>
